...
MODEL = dict(
    DEVICE='cuda',
    WEIGHTS=
    'output/gdrn/hb_pbr/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_hb/model_final.pth',
...
EXP_ID = 'convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_hb_test'
RESUME = False
